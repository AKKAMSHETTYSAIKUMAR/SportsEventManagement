...
public class SportsEventController {
    ...
    public ResponseEntity<Sports> addSport(@RequestBody Sports newsports)
    {
		/*
		 * String sportsId = (String) sportMap.get("sportsId"); String noOfPlayers =
		 * (String) sportMap.get("noOfPlayers"); String sportsName = (String)
		 * sportMap.get("sportsName"); String sportsType = (String)
		 * sportMap.get("sportsType");
		 */

        Sports sports = sportsEventService.addSport(newsports);
        return new ResponseEntity<>(sports, HttpStatus.OK);
    }
    ...
    {
		/*
		 * String eventId = (String) eventMap.get("eventId"); String eventDate =
		 * (String) eventMap.get("eventDate"); String eventName = (String)
		 * eventMap.get("eventName"); String noofSlots = (String)
		 * eventMap.get("noofSlots"); String sportsName = (String)
		 * eventMap.get("sportsName");
		 */

        Event event = sportsEventService.addEvent(newevent);
        return new ResponseEntity<>(event, HttpStatus.OK);
    }
